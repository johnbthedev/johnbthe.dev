        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Discover the web development services I offer and how they can
              help you
            </p>
          </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-base text-gray-500">
                      ...
                      updates and maintenance to remain fully functional. I
                      offer ongoing maintenance and support services to ensure
                      that your website stays up-to-date and runs smoothly at
                      all times.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-base text-gray-500">
                      ...
                      I offer comprehensive SEO services, including keyword
